...
public class MainMenu2 {
	 ...
	 */
	public static void main(String[] args, int Number_of_Mines) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainMenu2 window = new MainMenu2(Number_of_Mines);
	 ...
	 */
	public MainMenu2(int Number_of_Mines) {
		initialize(Number_of_Mines);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(int Number_of_Mines) {
		Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
		Database D = new Database(Number_of_Mines);
		...
		// MONITOR'S VALUE ////////// ////////// //////////	////////// ////////// //////////	
		JLabel MonitorValue = new JLabel(String.valueOf(Database.Number_of_Mines));
